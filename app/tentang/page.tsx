...
export const metadata: Metadata = {
  title: 'Tentang Kami',
  description: 'Kenali Cikal Pet Care Polewali Mandar dan layanan perawatan kucing yang tersedia.',
  ...
  return (
    <main className="min-h-screen bg-bg pb-20 pt-32">
      <section className="mx-auto max-w-5xl px-6 sm:px-8">
        ...
        <h1 className="mt-3 max-w-3xl text-4xl font-bold text-text md:text-5xl">Perawatan kucing yang jelas, mudah dipesan, dan penuh perhatian.</h1>
